...
export const FeatureCard = ({ feature }: Props) => {
  ...
  return (
    <>
      <Card className="border border-border bg-white cursor-pointer hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5">
        <CardHeader>
          <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center mb-4 group-hover/card:bg-primary group-hover/card:text-primary-foreground transition-colors duration-300">
            <Icon
              size={18}
              className="text-primary group-hover/card:text-primary-foreground transition-colors duration-300"
            />
          </div>
        </CardHeader>
        <CardContent>
