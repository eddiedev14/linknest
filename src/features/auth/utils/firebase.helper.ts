...
const createBaseNewUser = (email: string, username: string, password: string): User => {
  return {
    email,
    username,
    password,
...
export { getAuthErrorMessage, getUserWithoutPassword, createBaseNewUser, getUserId, getFirebaseToken };
